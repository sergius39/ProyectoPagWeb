...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["nombreRegistro"]) || empty($_POST["apellidoRegistro"]) || empty($_POST["apellidoRegistro"]) || empty($_POST["emailRegistro"]) || empty($_POST["pass1Registro"]) || empty($_POST["pass2Registro"])) {
...
// Consulta SQL sin sentencias preparadas
...
$stmt->close();
    ...
    if (!$errorVacio && !$errorNombre && !$errorPass && !$errorTelefono && !$errorEmail) { 
